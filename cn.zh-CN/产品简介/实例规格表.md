...
|----|----|----|----|-----|------|----|
|副本集实例|独享型云盘|4核8GB|mdb.shard.2x.xlarge.d|3000|min\{1800+50\*存储空间, 21000\}|20~6000GB|
...
|4核32GB|mdb.shard.8x.xlarge.d|8000|min\{1800+50\*存储空间, 21000\}|
...
|独享型本地盘|2核16GB|mongo.x8.medium|2500|4500|250GB|
...
|单节点实例|通用型|4核8GB|dds.sn2.large.1|6000|min\{30 \* 存储空间，20000\}|20~2000GB|
