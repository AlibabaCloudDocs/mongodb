...
6.  Configure an IP whitelist.
    ...
    1.  Find the IP whitelist, and choose ![more](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/en-US/9545298951/p13851.png) \> **Manually Modify** in the **Actions** column.
    ...
    1.  Find the IP whitelist, and choose ![more](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/en-US/9545298951/p13851.png) \> **Import ECS Intranet IP** in the **Actions** column.
...
## Configure an IP whitelist for an ApsaraDB for MongoDB \(Serverless\) instance
...
6.  Configure an IP whitelist.
    ...
    1.  Find the IP whitelist, and choose ![more](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/en-US/9545298951/p13851.png) \> **Manually Edit** in the **Actions** column.
    ...
    1.  Find the IP whitelist, and choose ![more](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/en-US/9545298951/p13851.png) \> **Import ECS Internal IP Addresses** in the **Actions** column.
    ...
    3.  Click **OK**.
        ...
        **Note:** For easy O&M and access control, we recommend that you add an ECS security group. For more information, see [Add an ECS security group for an ApsaraDB for MongoDB \(Serverless\) instance](#section_vhe_zs7_345).
...
7.  In the dialog box that appears, select the target ECS security group.
    ...
    ![Add a security group](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/en-US/4027562061/p70088.png)
...
## Add an ECS security group for an ApsaraDB for MongoDB \(Serverless\) instance
...
7.  In the **Add Security Group** dialog box, select the ECS security group.
...
6.  Delete an IP whitelist or an ECS security group.
    ...
    1.  Find the IP whitelist, and choose **![More](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/en-US/9545298951/p13851.png)** \> **Delete Whitelist Group** in the **Actions** column.

        ![Delete an IP whitelist](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/en-US/5027562061/p67412.png)
...
## Delete an IP whitelist or an ECS security group of an ApsaraDB for MongoDB \(Serverless\) instance
...
6.  Delete an IP whitelist or an ECS security group.
    ...
    1.  Find the IP whitelist, and choose **![More](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/en-US/9545298951/p13851.png)** \> **Delete Whitelist** in the **Actions** column.
