...
5.  单击页面右上角的![更多](https://static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/5639373261/p283135.png)，选择**登录数据库**，并选择要登录的数据库节点（**Primary**或**Secondary**），跳转到**数据管理DMS**页面。

    ![登录数据库](https://static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/7739373261/p283562.png)
