...
-   已将ECS实例的IP地址加入MongoDB实例的白名单中，详情请参见[设置白名单](/intl.zh-CN/用户指南/数据安全性/设置白名单及安全组.md)。
...
-   将MongoDB实例的网络类型切换为经典网络，详情请参见[从专有网络切换为经典网络](/intl.zh-CN/用户指南/管理网络连接/切换实例网络类型.md)。
...
将MongoDB实例切换到ECS实例所属的专有网络中，详情请参见[从经典网络切换为专有网络](/intl.zh-CN/用户指南/管理网络连接/切换实例网络类型.md)。
